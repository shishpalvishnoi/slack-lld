...
func (cu *ChannelUpdate) SetWorkspaceID(i int64) *ChannelUpdate {
	cu.mutation.ResetWorkspaceID()
	cu.mutation.SetWorkspaceID(i)
	return cu
}

// AddWorkspaceID adds i to the "workspace_id" field.
func (cu *ChannelUpdate) AddWorkspaceID(i int64) *ChannelUpdate {
	cu.mutation.AddWorkspaceID(i)
	return cu
}
...
func (cu *ChannelUpdate) SetCreatedBy(s string) *ChannelUpdate {
...
func (cu *ChannelUpdate) sqlSave(ctx context.Context) (n int, err error) {
	...
	if value, ok := cu.mutation.WorkspaceID(); ok {
		_spec.SetField(channel.FieldWorkspaceID, field.TypeInt64, value)
	}
	if value, ok := cu.mutation.AddedWorkspaceID(); ok {
		_spec.AddField(channel.FieldWorkspaceID, field.TypeInt64, value)
	}
...
// SetWorkspaceID sets the "workspace_id" field.
func (cuo *ChannelUpdateOne) SetWorkspaceID(i int64) *ChannelUpdateOne {
	cuo.mutation.ResetWorkspaceID()
	cuo.mutation.SetWorkspaceID(i)
	return cuo
}

// AddWorkspaceID adds i to the "workspace_id" field.
func (cuo *ChannelUpdateOne) AddWorkspaceID(i int64) *ChannelUpdateOne {
	cuo.mutation.AddWorkspaceID(i)
	return cuo
}
...
// SetCreatedBy sets the "created_by" field.
func (cuo *ChannelUpdateOne) SetCreatedBy(s string) *ChannelUpdateOne {
...
func (cuo *ChannelUpdateOne) sqlSave(ctx context.Context) (_node *Channel, err error) {
	...
	if value, ok := cuo.mutation.WorkspaceID(); ok {
		_spec.SetField(channel.FieldWorkspaceID, field.TypeInt64, value)
	}
	if value, ok := cuo.mutation.AddedWorkspaceID(); ok {
		_spec.AddField(channel.FieldWorkspaceID, field.TypeInt64, value)
	}
