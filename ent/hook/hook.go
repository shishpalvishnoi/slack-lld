...
type UserChannelFunc func(context.Context, *ent.UserChannelMutation) (ent.Value, error)

// Mutate calls f(ctx, m).
func (f UserChannelFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	if mv, ok := m.(*ent.UserChannelMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *ent.UserChannelMutation", m)
}

// The UserWorkspaceFunc type is an adapter to allow the use of ordinary
// function as UserWorkspace mutator.
type UserWorkspaceFunc func(context.Context, *ent.UserWorkspaceMutation) (ent.Value, error)

// Mutate calls f(ctx, m).
func (f UserWorkspaceFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	if mv, ok := m.(*ent.UserWorkspaceMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *ent.UserWorkspaceMutation", m)
}
